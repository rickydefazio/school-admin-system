          ...
          <form>
            <div classNameName="grid-66">
              ...
              <div className="course--description">
                <div>
                  <textarea id="description" name="description" className="" placeholder="Course description..." value="High-end furniture projects are great to dream about. But unless you have a well-equipped shop and some serious woodworking experience to draw on, it can be difficult to turn the dream into a reality.
              ...
              <div className="course--stats">
                <ul className="course--stats--list">
                  ...
                  <li className="course--stats--list--item">
                    ...
                    <div>
                      <textarea id="materialsNeeded" name="materialsNeeded" className="" placeholder="List materials..." value= "* 1/2 x 3/4 inch parting strip
                      * 1 x 2 common pine
                      * 1 x 4 common pine
                      * 1 x 10 common pine
